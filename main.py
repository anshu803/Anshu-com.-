...
# BOT & CONFIGURATION
# ---------------------------------------------------------
BOT_TOKEN = os.environ.get("BOT_TOKEN", "8965215390:AAE6lOqvzV4dGjlNTYgxwAVVFP9MsFzeSmo")
...
def process_user_complaint(message):
    ...
    try:
        ...
        bot.send_message(message.chat.id, "⚠️ Complaint error. Direct Admin se contact karein.", reply_markup=